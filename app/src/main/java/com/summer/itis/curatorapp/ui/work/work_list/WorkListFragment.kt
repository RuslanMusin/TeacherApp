...
import com.summer.itis.curatorapp.ui.theme.theme_list.ThemeListPresenter
...
class WorkListFragment : BaseFragment<WorkListPresenter>(), WorkListView {
 ...
 */
    ...
    private fun setupViewPager(viewPager: ViewPager) {
        ...
        fragments.add(PastWorkListFragment.newInstance(mainListener))
        fragments.add(MyWorkListFragment.newInstance(mainListener))
        adapter.addFragment(fragments[0], getString(R.string.past_works))
        adapter.addFragment(fragments[1], getString(R.string.my_works))
